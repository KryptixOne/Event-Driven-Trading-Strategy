...
def create_signals(df):
    ...
    # -----------------------------------------
    # 2. Scale features
    feature_cols = ['Mentions', 'Volume', 'Open Price', 'Close Price', 'Mentions_Change', 'Volume_Change']
    df_train, df_val, df_test, scaler = scale_features(df_train, df_val, df_test, feature_cols=feature_cols)
...
if __name__ == "__main__":
    ...
    if single_day_test:
        df_signals = create_signals(df_all)
